...
# DESCRIPTION:  The script 'plot2.R', constructs and saves a bar-chart
#               of the 'Total Emissions from PM2.5 (in million of tons),
#               for the Baltimore City, over the years 1999, 2002, 2005 and 2008.
...
#                 3. Subsets the variables and observations needed to construct plot.
...
message("EXECUTING THE SCRIPT: 'plot2.R'")
...
################################################################################
# STEP 3: Subsets the variables and observations needed to construct plot
################################################################################

# Subsets the target variables and obsrevations.
...
# Changes the units of total emissions from tons to thousand of tons.
target_data <- step_to_target_data_2 / 1000

# A message that is expected to appear, when this STEP had been executed successfully.
message("  DONE --> STEP 3: Subsets the variables and obsrvations needed to construct plot.")
...
title(main = expression("Total Emissions from PM"[2.5] ~ " in the Baltimore City, Maryland"),
      cex.main = 1.4,
      xlab = "Year",
      ylab = expression("Emissions from PM"[2.5] ~ " (in thousand of tons)"))
...
# Closes the graphical device and saves the plot as 'plot2.png'.
...
message("SUCCESSfully created 'plot2.png' in the working directory.")
# THE END ######################################################################
